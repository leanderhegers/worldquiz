...
// and stayed.
// colorblind: uses the Okabe-Ito palette (designed to stay pairwise distinguishable under
// protanopia/deuteranopia/tritanopia) specifically so found/wrong/skipped/hover never rely on
// a red-vs-green distinction the way every other theme's found (green) vs wrong (red) does.
const THEMES={atlas:{bg:'#3a80b8',sph:'#4a90cc',grd:'#2a70a8',avail:'#e0d4b4',found:'#4a8a30',dim:'#a8c4d8',hov:'#ccc0a0',wrong:'#c03820',skipped:'#d97c1a',bar:'#4a8a30',dot:'rgba(0,0,0,0.85)',border:'#0a2a52',mtn:'#8c6239'},neon:{bg:'#0a0420',sph:'#0e0838',grd:'#2a1550',avail:'#4a2a6a',found:'#05d9e8',dim:'#1a0e30',hov:'#ff2a6d',wrong:'#ff1f4f',skipped:'#ff8a00',bar:'#05d9e8',dot:'rgba(5,217,232,0.9)',border:'#c030e0',mtn:'#e8b923'},terrain:{bg:'#2878a8',sph:'#3088b8',grd:'#1e6898',avail:'#6a9a58',found:'#2e7d20',dim:'#8ab0c8',hov:'#e8dca0',wrong:'#c03820',skipped:'#d97c1a',bar:'#2e7d20',dot:'rgba(0,0,0,0.85)',border:'#000',mtn:'#7a5230'},colorblind:{bg:'#3a5a78',sph:'#4a6a88',grd:'#2a4a68',avail:'#ece6d6',found:'#009e73',dim:'#a8b8c4',hov:'#e69f00',wrong:'#d55e00',skipped:'#cc79a7',bar:'#009e73',dot:'rgba(0,0,0,0.85)',border:'#1a1a1a',mtn:'#8c6239'}};
const CONT_KEYS=['EU','AF','AS','NA','SA','OC'];
const THEME_DOT={atlas:'#b0a080',neon:'#ff2a6d',terrain:'#6a9a58',colorblind:'#009e73'};
...
function themeGroup(){return og(t('themeLbl'),
  ['atlas','neon','terrain','colorblind'].map(k=>`<button class="tp${theme===k?' active':''}" onclick="setTheme('${k}')"><span class="dot" style="background:${THEME_DOT[k]};"></span><span>${t('themes')[k]}</span></button>`).join(''));}
